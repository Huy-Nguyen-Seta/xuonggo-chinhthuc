...
@Controller(value = "ListdoneDealcontroller")
public class ListdoneDealController {
	@Autowired
	private MessageUtil messageUtil;
	@Autowired 
	private Idealservice deal;
	@RequestMapping(value = "/quan-tri/listdanhsachxong",method = RequestMethod.GET)
...
if (request.getParameter("message") != null) {
		...
		model.addObject("list",gson.toJson(deal.findAllByStatusUserAccep(1)));
		return model;
	}
