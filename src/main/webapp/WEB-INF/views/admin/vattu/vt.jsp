...
<html>
	...
	<body>
		...
		<form action="<c:url value='/quan-tri/vtu'/>" id="formSubmit" method="get" enctype="multipart/form-data">
									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createNewURL" value="/quan-tri/vtu/chinh-sua?page=${model.page }"/>
												<a flag="info"
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>${item.chatlieu}</td>
															<td>
																<c:url var="updateNewURL" value="/quan-tri/vtu/chinh-sua">
